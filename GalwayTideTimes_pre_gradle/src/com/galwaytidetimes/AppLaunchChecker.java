...
public class AppLaunchChecker {
	...
	public static boolean checkFirstOrRateLaunch(Context mContext) {
		SharedPreferences prefs = mContext.getSharedPreferences(
				Constants.APP_LAUNCHER_CHECKER_PREF, 0);
		if (prefs.getBoolean(Constants.DONT_ASK_AGAIN, false)) {
			return false;
		}
	...
	public static void showRateDialog(final Context mContext,
		...
		alertDialog.setTitle(String.format(
				mContext.getString(R.string.rate_app), APP_TITLE));
		alertDialog.setMessage(String.format(
				mContext.getString(R.string.rate_app_text), APP_TITLE));
		...
		alertDialog.setButton(AlertDialog.BUTTON_POSITIVE,
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int id) {
						...
						// mContext.getString(R.string.google_play_launched),
		...
		alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE,
				mContext.getString(R.string.remind),
				new DialogInterface.OnClickListener() {
